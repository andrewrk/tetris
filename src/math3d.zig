...
pub const mat4x4_identity = Mat4x4{ .data = [_][4]f32{
...
fn testScale() void {
    ...
    const expected = Mat4x4{ .data = [_][4]f32{
...
fn testMult() void {
    ...
    const answer = Mat4x4{ .data = [_][4]f32{
